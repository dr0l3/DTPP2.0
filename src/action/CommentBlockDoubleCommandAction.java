 ...
 */
public class CommentBlockDoubleCommandAction extends AnAction {
  public void actionPerformed(AnActionEvent e) {
    ...
    SingleLayoutCommand commandToExecute = new DoubleLayoutCommand(e,
                                                                   commandsBeforeJump,
                                                                   commandsAfterJump,
                                                                   "doublecommandrunnable.CommentBlockDoubleCommandRunnable");
